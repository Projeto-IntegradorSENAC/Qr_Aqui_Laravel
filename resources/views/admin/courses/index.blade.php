                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="CoursesAddModalLabel">Informações do Curso</h5>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="addCourse rounded-0 shadow-none btn btn-primary">{{ __('Adicionar Novo Curso') }}</button>
                                            <button type="button"
                                                class="updateCourse rounded-0 shadow-none btn btn-info">{{ __('Atualizar Curso') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
