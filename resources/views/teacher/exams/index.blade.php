                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="ExamAddModalLabel">Selecione abaixo</h5>
                                        </div>
                                            ...
                                            <form>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Curso</small>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Nº Andar / Sala</small>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Dia</small>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Horário de inicio</small>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Final do horário</small>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="addExam rounded-0 shadow-none btn btn-primary">{{ __('Adicionar') }}</button>
                                            <button type="button"
                                                class="updateExam rounded-0 shadow-none btn btn-info">{{ __('Atualizar') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="row">Dia</th>
                                        <th scope="row">Horário de inicio</th>
                                        <th scope="row">Final do horário</th>
