                            ...
                            <div class="row mb-3">
                                <div class="col-md-10 m-auto">
                                    <select name="role" id="role"
                                        ...
                                        <option value="Administrator" @if ($user->role == 'Administrator') selected @endif >Administrador(a)</option>
                                        <option value="Teacher" @if ($user->role == 'Teacher') selected @endif >Professor(a)</option>
                                    </select>
                                    @error('role')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
