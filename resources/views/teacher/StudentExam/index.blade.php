                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="studentExamsLabel">Informe aluno e curso desejados</h5>
                                        </div>
                                            ...
                                            <form>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Nome do estudante</small>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="addExamStudent rounded-0 shadow-none btn btn-primary">{{ __('Adicionar') }}</button>
                                            <button type="button"
                                                class="updateExamStudent rounded-0 shadow-none btn btn-info">{{ __('Atualizar') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="row">Dia</th>
                                        <th scope="row">Inicio do horário</th>
