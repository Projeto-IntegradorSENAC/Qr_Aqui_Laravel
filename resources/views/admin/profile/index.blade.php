    ...
    <div class="container">
            ...
            <div class="col-6">
                <div class="card border-0 shadow-lg">
                    <div class="card-header border-primary bg-transparent">
                        <h2 class="lead fs-3 fw-bolder text-primary">Informação Pessoal</h2>
                    </div>
                    <div class="card-body col-10 m-auto">
                        ...
                        <div class="input-group mb-3 text-center">
                            <button type="button" class="savePersonalInformation btn btn-primary rounded-0 shadow-none">
                                <span> <i class="fa-solid fa-floppy-disk mx-2"></i>Salvar</span>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center mt-2">
            <div class="col-6">
                <div class="card border-0 shadow-lg">
                    <div class="card-header border-primary bg-transparent">
                        <h2 class="lead fs-3 fw-bolder text-primary">Redefinir Senha</h2>
                    </div>
                    <div class="card-body col-10 m-auto">
                        <div class="col-md-12 m-auto mb-3">
        ...
        <div class="row justify-content-center mt-2">
            <div class="col-6">
                <div class="card border-0 shadow-lg">
                    <div class="card-header border-primary bg-transparent">
                        <h2 class="lead fs-3 fw-bolder text-primary">Informação do Perfil</h2>
                    </div>
                    <div class="card-body col-10 m-auto">
                        <div class="col-md-12 m-auto mb-3">
                            <input id="phone" type="text" class="phone form-control shadow-none rounded-0" name="phone"
                                value="{{ $profile->phone }}" placeholder="Telefone">
                        ...
                        <div class="col-md-12 m-auto mb-3">
                            <input id="address" type="text" class="address form-control shadow-none rounded-0"
                                name="address" value="{{ $profile->address }}" placeholder="Endereço">
                        ...
                        <div class="col-md-12 m-auto mb-3">
                            <select name="degree" id="degree" size="3" class="degree form-control shadow-none rounded-0">
                                <option value="Bachelor" @if ('Bachelor' == $profile->degree) selected @endif>Bacharel</option>
                                <option value="Master" @if ('Master' == $profile->degree) selected @endif>Mestre</option>
                                <option value="Doctoral" @if ('Doctoral' == $profile->degree) selected @endif>Doutor(a)</option>
                            </select>
                        ...
                        <div class="col-md-12 m-auto mb-3">
                            <select name="gender" id="gender" size="2" class="gender form-control shadow-none rounded-0">
                                <option value="Male" @if ('Male' == $profile->gender) selected @endif>Masculino</option>
                                <option value="Female" @if ('Female' == $profile->gender) selected @endif>Feminino</option>
                            </select>
