...
<head>
    ...
    <title>QR Aqui | @yield('title')</title>
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link  @yield('activeProfile')"
                                    href="{{ route('profile.index') }}">{{ __('Meu Perfil') }}</a>
                            </li>
                            @if (Auth::user()->role == 'Administrator')
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeUsers')"
                                        href="{{ route('users.index') }}">{{ __('Cadastro de Usuário') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeHalls')"
                                        href="{{ route('halls.index') }}">{{ __('Salas') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeCourses')"
                                        href="{{ route('courses.index') }}">{{ __('Cursos') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeStudents')"
                                        href="{{ route('students.index') }}">{{ __('Estudantes') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeColleges')"
                                        href="{{ route('colleges.index') }}">{{ __('Instituições') }}</a>
                                </li>
                            @endif
                            @if (Auth::user()->role == 'Teacher')
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeStudentExam')"
                                        href="{{ route('studentExam.index') }}">{{ __('Tabela de Presença') }}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  @yield('activeExams')"
                                        href="{{ route('exams.index') }}">{{ __('Cronograma de Aulas') }}
                                    </a>
                                </li>
                            @endif
