                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="StudentAddModalLabel">Informações do Estudante</h5>
                                        </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <input id="studentId" type="text"
                                                            ...
                                                            autocomplete="studentId" autofocus placeholder="Estudante ID...">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <input id="address" type="text"
                                                            ...
                                                            autocomplete="address" autofocus placeholder="Endereço...">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <select name="degree" id="degree" size="3"
                                                            ...
                                                            <option value="Doctoral">Doutorado</option>
                                                        </select>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="addStudent rounded-0 shadow-none btn btn-primary">{{ __('Adicionar Novo Estudante') }}</button>
                                            <button type="button"
                                                class="updateStudent rounded-0 shadow-none btn btn-info">{{ __('Atualizar Estudante') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="row">Registro Geral</th>
                                        <th scope="row">Fone</th>
                                        <th scope="row">E-mail</th>
                                        <th scope="row">Endereço</th>
                                        <th scope="row">Gênero</th>
                                        <th scope="row">Idade</th>
                                        <th scope="row">Grau de formação</th>
