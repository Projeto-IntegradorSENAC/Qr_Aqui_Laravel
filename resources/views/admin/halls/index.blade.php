                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="HallsAddModalLabel">Informações da Sala</h5>
                                        </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <input id="floorNo" type="text"
                                                            ...
                                                            autocomplete="floorNo" autofocus placeholder="Andar Nª...">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <input id="hallNo" type="text"
                                                            ...
                                                            autocomplete="hallNo" autofocus placeholder="Sala Nª...">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="addHall rounded-0 shadow-none btn btn-primary">{{ __('Adicionar nova Sala') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
